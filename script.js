// If favourite meal does not exist in local storage it shows array of favourite
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// To fetch data from Meals API and return its value
...
// To display the all meals present in main acording to search input value by user
...
// This function shows discription of meals
...
// This shows all the list of favourite meals
...
// This function adds the functionality of adding and removing meals in favourite list
